...
public class DictTypeExample {
    ...
    public DictTypeExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public DictTypeExample orderBy(String ... orderByClauses) {
    ...
    public DictTypeExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public DictTypeExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private DictTypeExample example;

        protected Criteria(DictTypeExample example) {
            super();
            this.example = example;
        }

        public DictTypeExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.weweibuy.bds.model.example.DictTypeExample example);
    }
}