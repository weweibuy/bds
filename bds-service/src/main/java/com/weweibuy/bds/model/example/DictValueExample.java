...
public class DictValueExample {
    ...
    public DictValueExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public DictValueExample orderBy(String ... orderByClauses) {
    ...
    public DictValueExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public DictValueExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private DictValueExample example;

        protected Criteria(DictValueExample example) {
            super();
            this.example = example;
        }

        public DictValueExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.weweibuy.bds.model.example.DictValueExample example);
    }
}